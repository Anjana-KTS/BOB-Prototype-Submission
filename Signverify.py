...
def signverify(signid) :   
    ...
    n_input = 9
    train_person_id = signid
    test_image_path = r'sign.png'
    ...
    # real\001001_001.png
    if(evaluate(train_path, test_path, type2=True)):
        SignVerify = "Genuine Image"
    else:
        SignVerify = "Forged Image"
